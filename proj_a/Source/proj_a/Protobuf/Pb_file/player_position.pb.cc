...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_player_5fposition_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_player_5fposition_2eproto = nullptr;
const ::uint32_t
    TableStruct_player_5fposition_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        PROTOBUF_FIELD_OFFSET(::PlayerPosition, _impl_._has_bits_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, 13, -1, sizeof(::PlayerPosition)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::_PlayerPosition_default_instance_._instance,
};
const char descriptor_table_protodef_player_5fposition_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
static ::absl::once_flag descriptor_table_player_5fposition_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_player_5fposition_2eproto = {
    false,
    false,
    191,
    descriptor_table_protodef_player_5fposition_2eproto,
    "player_position.proto",
    &descriptor_table_player_5fposition_2eproto_once,
    descriptor_table_player_5fposition_2eproto_deps,
    2,
    1,
    schemas,
    file_default_instances,
    TableStruct_player_5fposition_2eproto::offsets,
    file_level_metadata_player_5fposition_2eproto,
    file_level_enum_descriptors_player_5fposition_2eproto,
...
class PlayerPosition::_Internal {
 public:
  using HasBits = decltype(std::declval<PlayerPosition>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
    8 * PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_._has_bits_);
};
...
PlayerPosition::PlayerPosition(
    ...
    const PlayerPosition& from)
    : ::google::protobuf::Message(arena) {
  PlayerPosition* const _this = this;
  (void)_this;
  ...
  _impl_.position_ = (cached_has_bits & 0x00000001u) ? ::google::protobuf::Message::CopyConstruct<::Vec3>(
                        ...
                        : nullptr;
  _impl_.orientation_ = (cached_has_bits & 0x00000002u) ? ::google::protobuf::Message::CopyConstruct<::Vec3>(
...
PlayerPosition::GetClassData() const {
...
const ::_pbi::TcParseTable<3, 5, 2, 41, 2> PlayerPosition::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_._has_bits_),
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GetTable<::PlayerPosition>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
    // string player_id = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.player_id_)}},
    // .Vec3 position = 2;
    {::_pbi::TcParser::FastMtS1,
     {18, 0, 0, PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.position_)}},
    // .Vec3 orientation = 3;
    {::_pbi::TcParser::FastMtS1,
     {26, 1, 1, PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.orientation_)}},
    // .State state = 4;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(PlayerPosition, _impl_.state_), 63>(),
     {32, 63, 0, PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.state_)}},
    // string timestamp = 5;
    {::_pbi::TcParser::FastUS1,
     {42, 63, 0, PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.timestamp_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // string player_id = 1;
    {PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.player_id_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // .Vec3 position = 2;
    {PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.position_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // .Vec3 orientation = 3;
    {PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.orientation_), _Internal::kHasBitsOffset + 1, 1,
    (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // .State state = 4;
    {PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.state_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
    // string timestamp = 5;
    {PROTOBUF_FIELD_OFFSET(PlayerPosition, _impl_.timestamp_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }}, {{
...
::uint8_t* PlayerPosition::_InternalSerialize(
  ...
  if (!this->_internal_player_id().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "PlayerPosition.player_id");
  ...
  if (!this->_internal_timestamp().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "PlayerPosition.timestamp");
...
::google::protobuf::Metadata PlayerPosition::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_player_5fposition_2eproto_getter,
                                   &descriptor_table_player_5fposition_2eproto_once,
...
static ::std::false_type _static_init_ PROTOBUF_UNUSED =
    (::_pbi::AddDescriptors(&descriptor_table_player_5fposition_2eproto),
     ::std::false_type{});
